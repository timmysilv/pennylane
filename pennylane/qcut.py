...
from typing import Tuple, Any, Dict, Union, Callable, Optional, Sequence
from functools import partial

from pennylane.operation import Operation, Operator, AnyWires
...
@batch_transform
def cut_circuit(tape: QuantumTape, method: Optional[Union[str, Callable]] = None, **kwargs) -> Tuple[Tuple[QuantumTape], Callable]:
    """Main transform"""
...
def example_method(graph: DiGraph, max_wires: Optional[int], max_gates: Optional[int], num_partitions: Optional[int], **kwargs) -> Tuple[Tuple[Tuple[Operator, Operator, Any]], Dict[str, Any]]:
